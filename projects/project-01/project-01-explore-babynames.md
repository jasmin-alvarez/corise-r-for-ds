...
tbl_names_by_letter |> 
  ...
  ggplot(aes(x = first_letter , y = pct_births , color = sex))+
  ...
  labs(
      title = "Distribution Of Births by First Letter & Sex",
      subtitle = "Year 2020",
      x = 'First Letter',
...
tbl_names_by_first_and_last_letter |> 
  ...
  labs(title = "Heatmap Of The % Births By First Letter And Last Letter ",
       subtitle = "In Year 2021",
       caption = "Source:SSA",
       x = "Last Letter",
       y = "First Letter",
...
tbl_names_vowel_consonant |> 
  ...
  labs(
      ...
      subtitle = "% Births By Combination Of First & Last Letter",
      caption = "Source:SSA",
      x = "Year",
      y = "Precentage of Births" 
    ) +
